...
from .Dual_Path_Adaptive_Detector import DPAD
from .MyNewClassHead import MyNewClassHead
import os
import cv2
...
class ROIHeadsLogisticGMMNew(ROIHeads):
    ...
    def __init__(
        ...
        self.complete_scores = DPAD(dim=1024)
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        box_predictor = MyNewClassHead(cfg, box_head.output_shape)
