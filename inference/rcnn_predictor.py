...
class GeneralizedRcnnPlainPredictor(ProbabilisticPredictor):
    ...
    def generalized_rcnn_probabilistic_inference(self,
        ...
        OOD_outputs = self.extract_OOD_mean(scores, num_bbox_reg_classes, box_delta, inter_feat, proposals, box_cls,
                                            outputs['complete_scores'], box_features_ood, pro_obj)
        ...
        outputs['complete_scores'][filter_inds[:, 0]], box_features_ood[filter_inds[:, 0]]
    ...
    def extract_OOD_mean(self, scores, num_bbox_reg_classes, box_delta, inter_feat, proposals, box_cls, complete_scores,
                         box_features_ood, box_logic):
